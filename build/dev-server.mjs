...
const server = http.createServer((req, res) => {
  ...
  if (urlPath === '/' || urlPath === '/index.html') {
    ...
    res.end(`<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover"><title>RAINBOW CLAW (DEV)</title><style>*{margin:0;padding:0;box-sizing:border-box}html,body{width:100%;height:100%;overflow:hidden;background:#050508;display:flex;align-items:center;justify-content:center;touch-action:none;-webkit-touch-callout:none;user-select:none;-webkit-user-select:none}canvas{display:block;image-rendering:pixelated;image-rendering:crisp-edges;max-width:100vw;max-height:100vh;aspect-ratio:4/3;object-fit:contain;box-shadow:0 0 50px rgba(0,0,0,0.9)}</style></head><body><canvas id="c" width="400" height="300"></canvas><script src="/bundle.js"><\/script></body></html>`);
    return;
  }
